...
<%
    ...
    String sname = "", price = "", phone = "", url = "",quantity = "",pname="",da="",qty="",mname="",lattitude="",mallid="";
        ...
        if (itr.hasNext()) {
            ...
            while (f_item.isFormField()) {
                ...
                if (field.equalsIgnoreCase("pname")) {
                 ...
                 if (field.equalsIgnoreCase("mallid")) {
                    mallid = value;
                } 
    ...
    String insert = "INSERT INTO `addproduct`(sname,pname,price,qty,mallid,photo)VALUES('" + sname + "','" + pname + "','" + price + "' ,'"+qty+"','"+mallid+"','"+file_name+"')";
