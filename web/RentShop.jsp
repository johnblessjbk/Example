        ...
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post">
                            <h3 class="text-center text-info">Rent Shop Sing-Up</h3>
                    ...
                    try {
                        if (request.getParameter("submit") != null) {
                            ...
                            String qry = "insert into rentshop(name,email,phone,addr,pass)values('" + fn + "','"+sn+"','" + aa + "','" + bb + "','" + qq + "')";
                            String q = "insert into login(name,pass,status,type,uid)values('" + sn + "','" + qq + "','rent','1',(select max(rsid)from rentshop))";
                ...
                <script>alert("Register failed");
                    window.location = 'RentShop.jsp';</script>
                    <%
                                }
                            }
                        } catch (Exception e) {
