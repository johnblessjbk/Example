    ...
    <div class="team">
        <div class="container">
            <div class="wthree-heading">
                <h3 class="w3l_header">Customer Request</h3>
            </div>
            <div class="agile_inner_grids">
            <%
                try {
                    String userid = (String) session.getAttribute("loguid");
                    String qrys = "select *from requesttorent where rentid='"+userid+"' ";
            ...
            <div class="col-md-4 w3_agile_team_grid_info">
                <img src="rep.jpg" alt=" " class="img-responsive" />
                <p><%=v.get(3)%></p>
                 <p><%=v.get(4)%></p>
                <ul class="footer_list_icons team_icons_agile">            
                  <a href="replay.jsp?id=<%=v.get(0)%>"> <button type="button" class="bb">Replay</button></a>
                </ul>
            </div>
