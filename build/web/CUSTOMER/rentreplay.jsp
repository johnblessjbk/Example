    ...
    <div class="team">
        <div class="container">
            <div class="wthree-heading">
                <h3 class="w3l_header">Replay From Rent Shop</h3>
            </div>
            ...
            <%
                ...
                try {
                    ...
                    String qrys = "select replay.des from replay,requesttorent where requesttorent.rentqid=replay.reqid and requesttorent.userid='"+userids+"'";
