    ...
    <div class="stats-bottom contact">
        <div class="container">			
            <div class="wthree-heading">
                <h3 class="w3l_header">MY SHOP</h3>
                <p class="quia">OUR RENT SHOP</p>
            </div>
            ...
            <%
                try {
                    ...
                    String qrys = "select *from addrentshop where shopid='" + userid + "'";
            ...
            <div class="col-md-4 agileinfo_services_grid">
                <div class="agileinfo_services_grid1" id="hh">
                    <img src="../assets/images/<%=v.get(8)%>"  alt=" "  height="170px" width="170px" />
                    <h4><%=v.get(1)%></h4>
                    <p><%=v.get(2)%></p>
                    <p><%=v.get(4)%></p>
                    <p><%=v.get(3)%></p>
