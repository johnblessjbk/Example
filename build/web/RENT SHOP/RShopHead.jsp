                ...
                <nav class="navbar navbar-default">
                    <div class="navbar-header navbar-left">
                        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                            ...
                            <h1><a class="navbar-brand" href=""><i class="fa fa-home" aria-hidden="true"></i> E-MarT <span><sub>Rent Shop</sub></span> </a></h1>
                    </div>
                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                        <nav class="menu menu--juliet">
                            <ul class="nav navbar-nav">
                                <li><a href="RSHome.jsp">Home</a></li>
                                 <li><a href="newrentshop.jsp" >New Rent-Shop</a></li>

                                <li><a href="myrentshop.jsp">My Rent-Shop</a></li>     
                                 <li><a href="cusrequest.jsp">Customer Request</a></li>     

                                <li class="active"><a href="../WebHome.jsp">Logout</a></li>
                            </ul>
